      ...
      <div className="h-full overflow-auto">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <div>
              <h1 className="text-2xl font-bold text-green-600">Zoning Application Logs</h1>
              <p className="text-gray-600">Track all zoning application activities and workflow actions</p>
            </div>
          </div>
